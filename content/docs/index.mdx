---
title: What is xNAUT?
description: A native 8 MB terminal built for the agent era — local-first AI, live agent status, and cryptographically signed work sessions.
---

xNAUT is a native terminal (Rust + Tauri v2, ~8 MB) for developers who work with AI coding agents. One app holds:

- **Terminals** — tabs, up to 16 split panes, 12 themes with full ANSI palettes, bundled Nerd Fonts
